...
export function DashboardNav({ navItems, profile, user }: any) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      {open && (
        <nav className="md:hidden fixed inset-0 top-16 z-40 flex flex-col bg-sidebar text-sidebar-foreground border-b border-sidebar-border">
